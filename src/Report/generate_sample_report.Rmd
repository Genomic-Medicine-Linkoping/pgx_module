...
header_table <- data.frame(
  row_table = c("Prov ID", "Sekvenserings ID", "dbSNP", "Referensgenomens sökväg"),
  text = c(params$sample, params$seqid, params$dbsnp, params$ref)
)
...
if (dim(interaction_guidelines)[1] != 0) {
